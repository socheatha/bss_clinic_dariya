		...
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group">
					...
					{!! Form::textarea('address', Auth::user()->setting()->address, ['class' => 'form-control ', 'placeholder' => 'address', 'required']) !!}
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group">
					...
					{!! Form::textarea('echo_address', Auth::user()->setting()->echo_address, ['class' => 'form-control ', 'placeholder' => 'echo address', 'required']) !!}
				</div>
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group">
					...
					{!! Form::textarea('description', Auth::user()->setting()->description, ['class' => 'form-control ', 'placeholder' => 'description', 'required']) !!}
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group">
					...
					{!! Form::textarea('echo_description', Auth::user()->setting()->echo_description, ['class' => 'form-control ', 'placeholder' => 'echo description', 'required']) !!}
				</div>
			</div>
		</div>
		<div class="row">
