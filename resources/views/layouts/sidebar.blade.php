	...
	<div class="sidebar">
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column {{ ((Auth::user()->setting()->legacy == '1')? 'nav-legacy nav-flat' : 'sidebar-light-indigo') }} nav-child-indent text-sm" data-widget="treeview" role="menu" data-accordion="false">
				...
				@canany(['Echo Index','Echo Create', 'Echo Edit', 'Echo Delete','Echo Print', 'Echo Default Description Index', 'Echo Default Description Create', 'Echo Default Description Edit', 'Echo Default Description Delete'])
